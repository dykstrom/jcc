...
/**
 * Compile-and-run integration tests for COL that exercise the
 * COL standard library libjcccol.
 *
 * @author Johan Dykstrom
 */
class ColCompileAndRunFunctionsIT : AbstractIntegrationTests() {
    ...
    fun shouldCallMillis() {
        ...
        runAndAssertSuccess(listOf(), listOf("true"))
    }
}
