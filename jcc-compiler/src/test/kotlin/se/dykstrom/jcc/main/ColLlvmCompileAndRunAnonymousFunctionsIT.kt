...
/**
 * Compile-and-run integration tests for the COL LLVM backend, specifically for testing
 * anonymous functions.
 *
 * @author Johan Dykstrom
 */
@Tag("LLVM")
class ColLlvmCompileAndRunAnonymousFunctionsIT : AbstractIntegrationTests() {
