...
public class IncCodeGenerator extends AbstractOpAssignCodeGenerator implements LlvmStatementCodeGenerator<IncStatement> {
    ...
    @Override
    public void toLlvm(final IncStatement statement, final List<Line> lines, final SymbolTable symbolTable) {
        toLlvm(statement.getLhsExpression().getIdentifier(), lines, symbolTable, ADD, ONE);
    }
}
