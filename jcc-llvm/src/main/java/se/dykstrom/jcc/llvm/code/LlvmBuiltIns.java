...
public final class LlvmBuiltIns {
    ...
    public static final Function LF_ATAN_F32 = create(".atan", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.atan.f32");
    public static final Function LF_ATAN_F64 = create(".atan", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.atan.f64");
    ...
    public static final Function LF_COS_F32 = create(".cos", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.cos.f32");
    public static final Function LF_COS_F64 = create(".cos", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.cos.f64");
    public static final Function LF_EXP_F32 = create(".exp", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.exp.f32");
    public static final Function LF_EXP_F64 = create(".exp", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.exp.f64");
    public static final Function LF_EXP2_F32 = create(".exp2", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.exp2.f32");
    public static final Function LF_EXP2_F64 = create(".exp2", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.exp2.f64");
    ...
    public static final Function LF_LOG2_F64 = create(".log2", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.log2.f64");
    public static final Function LF_LOG10_F32 = create(".log10", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.log10.f32");
    public static final Function LF_LOG10_F64 = create(".log10", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.log10.f64");
    public static final Function LF_POW_F32_F32 = create(".pow", List.of(F32.INSTANCE, F32.INSTANCE), F32.INSTANCE, "llvm.pow.f32");
    ...
    public static final Function LF_SIN_F32 = create(".sin", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.sin.f32");
    ...
    public static final Function LF_TAN_F32 = create(".tan", List.of(F32.INSTANCE), F32.INSTANCE, "llvm.tan.f32");
    public static final Function LF_TAN_F64 = create(".tan", List.of(F64.INSTANCE), F64.INSTANCE, "llvm.tan.f64");
