...
public class BinaryCodeGenerator implements LlvmExpressionCodeGenerator<BinaryExpression> {

    private final LlvmCodeGenerator codeGenerator;
    private final LlvmOperator fOperator;
    private final LlvmOperator iOperator;

    public BinaryCodeGenerator(final LlvmCodeGenerator codeGenerator,
