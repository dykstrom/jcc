...
public class MulSemanticsParser extends AbstractSemanticsParserComponent<TypeManager, SemanticsParser>
        implements ExpressionSemanticsParser<MulExpression> {

    public MulSemanticsParser(final SemanticsParserContext context) {
        super(context);
    }
