...
public class MulSemanticsParser extends AbstractSemanticsParserComponent<ColTypeManager, SemanticsParser<ColTypeManager>>
        implements ExpressionSemanticsParser<MulExpression> {

    public MulSemanticsParser(final SemanticsParser<ColTypeManager> semanticsParser) {
