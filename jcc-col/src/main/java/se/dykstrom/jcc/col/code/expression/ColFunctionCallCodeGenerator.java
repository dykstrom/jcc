...
import se.dykstrom.jcc.col.compiler.ColAsmFunctions;
...
public class ColFunctionCallCodeGenerator extends FunctionCallCodeGenerator {

    public ColFunctionCallCodeGenerator(final AsmCodeGenerator codeGenerator) {
        super(codeGenerator);
    }
    ...
    public List<Line> generate(FunctionCallExpression expression, StorageLocation location) {
        return CodeContainer.withCodeContainer(cc -> {
            ...
            if (function instanceof BuiltInFunction) {
                final var optionalExpression = ColAsmFunctions.getInlineExpression(function, args);
                if (optionalExpression.isPresent()) {
                    ...
                    function = ColAsmFunctions.getLibraryFunction(function);
                }
            }
