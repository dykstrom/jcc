...
internal class ColLlvmCodeGeneratorUserFunctionTests : AbstractColCodeGeneratorTests() {
    ...
    fun shouldGenerateFunctionWithFunction2TypeArg() {
        ...
        // Then
        assertContains(result, listOf(
            "define i64 @foo(ptr %0)", // All function pointers are the same, regardless of their type
            "%a = alloca ptr",
            "store ptr %0, ptr %a",
        ))
    }
    ...
    fun shouldCallPrintWithFunctionArg() {
        ...
        // Then
        assertContains(result, listOf(
            "%0 = call i32 (ptr, ...) @printf(ptr @.printf.fmt.lp.I64.rp.to.I64, ptr @bar)",
        ))
    }
}
