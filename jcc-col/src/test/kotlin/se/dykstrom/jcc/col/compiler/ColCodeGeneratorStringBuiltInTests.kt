...
/**
 * Tests code generation of the COL string built-ins. What matters here is the
 ...
 */
internal class ColCodeGeneratorStringBuiltInTests : AbstractColCodeGeneratorTests() {
    ...
    fun shouldRegisterStringConversionResults() {
        ...
        assertContains(result, listOf(
            ...
            // LLVM's true is 1, which is what LiteralCodeGenerator maps BooleanLiteral.TRUE to
