 ...
 * operations that make COL need the collector are tested in [ColCodeGeneratorStringTests].
 */
internal class ColCodeGeneratorGcTests : AbstractColCodeGeneratorTests() {
