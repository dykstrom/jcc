...
/**
 * Tests code generation of COL strings: literals, concatenation through
 * libjcccol, equality through strcmp, printing, and string-typed vals. The garbage-collector
 * plumbing these programs depend on is tested in [ColCodeGeneratorGcTests].
 */
internal class ColCodeGeneratorStringTests : AbstractColCodeGeneratorTests() {
