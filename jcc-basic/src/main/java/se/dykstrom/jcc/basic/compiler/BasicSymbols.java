...
public class BasicSymbols extends SymbolTable {
    ...
    public static final Function BF_CSRLIN = new BuiltInFunction("csrlin", List.of(), I64.INSTANCE);
    ...
    public static final Function BF_POS_I64 = new BuiltInFunction("pos", List.of(I64.INSTANCE), I64.INSTANCE);
