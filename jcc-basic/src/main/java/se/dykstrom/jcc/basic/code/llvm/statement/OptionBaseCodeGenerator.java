...
import se.dykstrom.jcc.basic.compiler.BasicLlvmCodeGenerator;
...
/**
 * Handles the OPTION BASE statement on the LLVM backend. The base only affects the value returned
 ...
 */
public record OptionBaseCodeGenerator(BasicLlvmCodeGenerator cg) implements LlvmStatementCodeGenerator<OptionBaseStatement> {
