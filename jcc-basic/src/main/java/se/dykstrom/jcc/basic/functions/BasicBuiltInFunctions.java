...
public final class BasicBuiltInFunctions {
    ...
    public static final LibraryFunction FUN_CINT        = new LibraryFunction("cint",         List.of(F64.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("cint"));
    ...
    public static final LibraryFunction FUN_COMMAND     = new LibraryFunction("command$",     List.of(), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("command$"));
    public static final LibraryFunction FUN_CVD         = new LibraryFunction("cvd",          List.of(Str.INSTANCE), F64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("cvd"));
    ...
    public static final LibraryFunction FUN_INT         = new LibraryFunction("int",          List.of(F64.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("int_F64"));
    ...
    public static final LibraryFunction FUN_LTRIM       = new LibraryFunction("ltrim$",       List.of(Str.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("ltrim"));
    public static final LibraryFunction FUN_MKD         = new LibraryFunction("mkd$",         List.of(F64.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("mkd$"));
    public static final LibraryFunction FUN_MKI         = new LibraryFunction("mki$",         List.of(I64.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("mki$"));
    public static final LibraryFunction FUN_LBOUND      = new LibraryFunction("lbound",       List.of(Arr.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("lbound"));
    public static final LibraryFunction FUN_LBOUND_I64  = new LibraryFunction("lbound",       List.of(Arr.INSTANCE, I64.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("lbound_I64"));
    public static final LibraryFunction FUN_OCT         = new LibraryFunction("oct$",         List.of(I64.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("oct$"));
    public static final LibraryFunction FUN_RANDOMIZE   = new LibraryFunction("randomize",    List.of(F64.INSTANCE), Void.INSTANCE, LIB_JCC_BAS, new ExternalFunction("randomize"));
    public static final LibraryFunction FUN_SLEEP       = new LibraryFunction("_sleep",       List.of(F64.INSTANCE), Void.INSTANCE, LIB_JCC_BAS, new ExternalFunction("sleep_F64"));
    public static final LibraryFunction FUN_UBOUND      = new LibraryFunction("ubound",       List.of(Arr.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("ubound"));
    public static final LibraryFunction FUN_UBOUND_I64  = new LibraryFunction("ubound",       List.of(Arr.INSTANCE, I64.INSTANCE), I64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("ubound_I64"));
    public static final LibraryFunction FUN_RND         = new LibraryFunction("rnd",          List.of(), F64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("rnd"));
    public static final LibraryFunction FUN_RND_F64     = new LibraryFunction("rnd",          List.of(F64.INSTANCE), F64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("rnd_F64"));
    public static final LibraryFunction FUN_RTRIM       = new LibraryFunction("rtrim$",       List.of(Str.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("rtrim"));
    public static final LibraryFunction FUN_OPTION_BASE = new LibraryFunction("_option_base", List.of(I64.INSTANCE), Void.INSTANCE, LIB_JCC_BAS, new ExternalFunction("option_base"));
    ...
    public static final LibraryFunction FUN_STRING_STR  = new LibraryFunction("string$",      List.of(I64.INSTANCE, Str.INSTANCE), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("string$_Str"));
    ...
    public static final LibraryFunction FUN_TIME        = new LibraryFunction("time$",        List.of(), Str.INSTANCE, LIB_JCC_BAS, new ExternalFunction("time$"));
    public static final LibraryFunction FUN_TIMER       = new LibraryFunction("timer",        List.of(), F64.INSTANCE, LIB_JCC_BAS, new ExternalFunction("timer"));
