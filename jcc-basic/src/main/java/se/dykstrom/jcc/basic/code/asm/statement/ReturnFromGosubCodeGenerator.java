...
public class ReturnFromGosubCodeGenerator extends AbstractStatementCodeGenerator<ReturnFromGosubStatement, TypeManager, AsmCodeGenerator> {

    public ReturnFromGosubCodeGenerator(final AsmCodeGenerator codeGenerator) { super(codeGenerator); }
