...
public class ExitCodeGenerator extends AbstractStatementCodeGeneratorComponent<ExitStatement, TypeManager, AbstractCodeGenerator> {

    public ExitCodeGenerator(Context context) { super(context); }
