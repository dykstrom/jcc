...
public class CastToF64CodeGenerator extends AbstractExpressionCodeGenerator<CastToF64Expression, TypeManager, AsmCodeGenerator> {

    public CastToF64CodeGenerator(final AsmCodeGenerator codeGenerator) { super(codeGenerator); }

    @Override
    public List<Line> generate(final CastToF64Expression expression, final StorageLocation location) {
