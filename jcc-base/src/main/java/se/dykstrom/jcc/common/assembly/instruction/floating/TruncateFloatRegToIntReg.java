 ...
 * (a general purpose register). For example, this could be "cvttsd2si rbx, xmm0".
 *
 * @author Johan Dykstrom
 */
public class TruncateFloatRegToIntReg extends TruncateFloatToInt {

    public TruncateFloatRegToIntReg(FloatRegister source, Register destination) {
