...
/**
 * Represents a divide-assign statement such as 'value = value / 5' in BASIC, or 'value /= 5' in C.
 *
 * @author Johan Dykstrom
 */
public class IDivAssignStatement extends AbstractNode implements Statement {

    private final IdentifierExpression lhsExpression;
    private final LiteralExpression rhsExpression;

    public IDivAssignStatement(final int line,
                               final int column,
    ...
    /**
     * Creates a divide-assign statement from a normal assignment statement.
     */
    public static IDivAssignStatement from(final AssignStatement statement, final LiteralExpression rhsExpression) {
        return new IDivAssignStatement(statement.line(), statement.column(), statement.getLhsExpression(), rhsExpression);
    }
    ...
    public boolean equals(Object o) {
        ...
        IDivAssignStatement that = (IDivAssignStatement) o;
