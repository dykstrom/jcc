...
public class RoundCodeGenerator extends AbstractExpressionCodeGenerator<RoundExpression, TypeManager, AsmCodeGenerator> {

    public RoundCodeGenerator(final AsmCodeGenerator codeGenerator) { super(codeGenerator); }

    @Override
    public List<Line> generate(final RoundExpression expression, final StorageLocation location) {
        return withCodeContainer(cc -> {
            ...
            cc.add(new RoundFloatRegToFloatReg(register, register));
        });
    }
}
