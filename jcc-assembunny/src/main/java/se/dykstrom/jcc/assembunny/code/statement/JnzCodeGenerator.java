...
package se.dykstrom.jcc.assembunny.code.statement;
...
public class JnzCodeGenerator implements LlvmStatementCodeGenerator<JnzStatement> {
    ...
    private final AssembunnyCodeGenerator codeGenerator;

    public JnzCodeGenerator(AssembunnyCodeGenerator codeGenerator) {
