 ...
 * to the destination (a memory location). The memory location may be specified by an immediate memory
 * address as in "movsd [address], xmm0".
 *
 * @author Johan Dykstrom
 */
public class MoveFloatRegToMem extends MoveFloat {
