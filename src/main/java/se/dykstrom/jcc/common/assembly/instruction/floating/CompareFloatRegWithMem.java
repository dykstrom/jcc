 ...
 * (a floating point register) and the contents of operand 2 (a memory location), such as "ucomisd xmm0, 0".
 *
 * @author Johan Dykstrom
 */
public class CompareFloatRegWithMem extends CompareFloat {

    public CompareFloatRegWithMem(FloatRegister operand1, String operand2) {
