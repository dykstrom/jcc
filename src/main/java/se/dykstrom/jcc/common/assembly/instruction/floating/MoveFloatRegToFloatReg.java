 ...
 * to the destination (a floating point register) as in "movsd xmm1, xmm0".
 *
 * @author Johan Dykstrom
 */
public class MoveFloatRegToFloatReg extends MoveFloat {

    public MoveFloatRegToFloatReg(FloatRegister source, FloatRegister destination) {
