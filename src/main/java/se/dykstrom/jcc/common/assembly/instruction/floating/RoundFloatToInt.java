...
/**
 * Base class for all "cvtsd2si" floating point instructions. The "cvtsd2si" instruction rounds
 ...
 * "cvtsd2si rbx, xmm0" would leave the value "4" in register RBX.
 *
 * @author Johan Dykstrom
 */
public abstract class RoundFloatToInt implements Instruction {

    private final String source;
    private final String destination;

    RoundFloatToInt(String source, String destination) {
