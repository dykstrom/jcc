...
/**
 * Implements the "cint" function. This function converts the given argument, a numeric expression,
 * to an integer by rounding it to the closest integer.
 * 
 * Signature: cint(expression : F64) : I64
 * 
 * @author Johan Dykstrom
 */
public class BasicCintFunction extends AssemblyFunction {

    public static final String NAME = "cint";

    public BasicCintFunction() {
