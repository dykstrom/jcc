...
public class BasicMid2Function extends AssemblyFunction {
    ...
    public List<Code> codes() {
        return new BasicMid2Function.InternalCodeContainer().codes();
    }

    private static class InternalCodeContainer extends CodeContainer {
        private InternalCodeContainer() {
            // Create jump labels
            Label doneLabel = new Label("_mid$_done");
            Label errorLabel = new Label("_mid$_error");
            Label rightLabel = new Label("_mid$_right");
