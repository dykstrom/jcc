...
public class BasicCodeGeneratorIfTest extends AbstractBasicCodeGeneratorTest {
    ...
    public void shouldGenerateIfThenElse() {
        ...
        assertEquals(9, countInstances(codes, MoveImmToReg.class));
        // One for comparing the integers, and one for the if statement
        assertEquals(2, countInstances(codes, Cmp.class));
        // One for comparing the integers, and one for the if statement
        assertEquals(2, countInstances(codes, Je.class));
    ...
    public void shouldGenerateIfThenElseIfElse() {
        ...
        assertEquals(15, countInstances(codes, MoveImmToReg.class));
        // Two for comparing the integers, and two for the if statements
        assertEquals(4, countInstances(codes, Cmp.class));
        // Two for comparing the integers, and two for the if statements
        assertEquals(4, countInstances(codes, Je.class));
        // Two for comparing the integers, and two for the if statements
        assertEquals(4, countInstances(codes, Jmp.class));
    }
}
